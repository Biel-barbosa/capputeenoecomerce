...
const ProductCard = styled.div`
  display: flex;
  flex-direction: row;  /* Garante que a imagem ficará à esquerda e o texto à direita */
  gap: 1.5rem;
  background: #fff;
  padding: 1.5rem;
  border-radius: 12px;
  ...
  /* Responsividade para telas menores */
  @media (max-width: 768px) {
    flex-direction: column;  /* Em telas menores, coloca a imagem em cima e o texto embaixo */
    padding: 1rem;
  }
`;
