...
type Product = {
  ...
  category: string;
  createdAt: string;
  imageUrl: string; // Certifique-se de que todos os produtos possuem essa propriedade
}
...
const HomePage = () => {
  ...
  const filteredProducts = useMemo(() => {
    let products = allProducts.filter((product: Product) => { // Aqui tipamos a variável product
  ...
  return (
    <>
      ...
      <Container>
        ...
        <ProductsGrid>
          {paginatedProducts.map((product: Product) => ( // Aqui também tipamos a variável product
            <Card key={product.id}>
              <Image
